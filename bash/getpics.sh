...
#########################
# handling the tarfile
########################

# download the tarfile if we need it
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz

#unpack the tarfile if it is there, then delete the local copy of the tarfile
test -f ~/Pictures/pics.tgz && tar -zvxf ~/Pictures/pics.tgz -C ~/Pictures && rm ~/Pictures/pics.tgz
